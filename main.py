...
# Last Modified time: 2020-07-01 17:49:38
...
def dict_crawler(
    dictionary, depth=0, parent_list=["root"], parent_values_list=[], done=False
):
    ...
    while not exit_dict:
        ...
        try:
            ...
            try:
                ...
                exit_dict = dict_crawler(
                    dictionary[dest], depth, parent_list, parent_values_list, done
                )
            except:
                pass
        except:
        ...
        if inpt == "p":
            try:
                ...
                if parent_list[depth - 1] == "root":
                    ...
                    exit_dict = dict_crawler(
                        dest, depth, parent_list, parent_values_list, done
                    )
...
def run_main():
    ...
    sign_in_button = driver.find_elements_by_xpath(
        "/html/body/div/div[3]/form/table/tbody/tr[4]/td[1]/div/input"
    )[0]
    ...
    driver.get(
        "https://prodweb2.wit.edu/SSBPROD/twbkwbis.P_GenMenu?name=bmenu.P_StuMainMnu"
    )
    # print(driver.title)
    student_tab = driver.find_elements_by_xpath(
        "/html/body/div[1]/div[2]/span/map/table/tbody/tr[1]/td/table/tbody/tr/td[3]/a"
    )[0]
    # student tab
    # print(driver.title)

    registration_button = driver.find_elements_by_xpath(
        "/html/body/div[3]/table[1]/tbody/tr[1]/td[2]/a"
    )[0]
    registration_button.click()
    # print(driver.title)
    # registration button page
    search_button = driver.find_elements_by_xpath(
        "/html/body/div[3]/table[1]/tbody/tr[3]/td[2]/a"
    )[0]
    search_button.click()
    # print(driver.title)
    ...
    advanced_search_button = driver.find_elements_by_xpath(
        "/html/body/div[3]/form/input[18]"
    )[0]
    ...
    # go to big list
    section_search_button = driver.find_elements_by_xpath(
        "/html/body/div[3]/form/span/input[1]"
    )[0]
    ...
    for course in split_on_classes:
        crn = course[
            course.find('return true">') + 13 : course.find('return true">') + 18
        ]
        is_valid_crn = False
        try:
            int(crn)
    ...
    for crn in crns_to_watch:
        if not classes_dict[crn]["Full"]:
            ...
            add_or_drop_button = driver.find_elements_by_xpath(
                "/html/body/div[3]/table[1]/tbody/tr[2]/td[2]/a"
            )[0]
            ...
            status = driver.find_elements_by_xpath(
                "/html/body/div[3]/form/table[4]/tbody/tr[2]/td[1]"
            )[0]
